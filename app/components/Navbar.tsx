    ...
    <nav className={cn(
        ...
        <div className="flex items-center gap-2">
          {mounted && (
            <button
              ...
              className="p-2 rounded-lg glass transition-all hover:scale-110 hover:border-[var(--indigo)]"
          ...
          <a href={PERSONAL.resumeUrl} download className="hidden md:flex items-center gap-2 btn-indigo text-sm py-2">
            <Download className="w-3.5 h-3.5" />
            Resume
          </a>
          <button className="md:hidden p-2 rounded-lg glass" onClick={() => setMobileOpen(!mobileOpen)}>
      ...
      {mobileOpen && (
        <div className="md:hidden glass mx-4 mt-2 rounded-xl p-4 flex flex-col gap-1">
          ...
          <a href={PERSONAL.resumeUrl} download className="flex items-center gap-2 btn-indigo mt-2 justify-center">
            <Download className="w-3.5 h-3.5" />
            Download Resume
          </a>
        </div>
